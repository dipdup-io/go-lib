...
func TestTypedAst_FromJSONSchema(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			name: "granadanet/KT1Tg6WFuTU47Z8rPeBhDbgx1DmX1SWCZcZq/metadata/get_balance",
...
func TestTypedAst_ParametersForExecution(t *testing.T) {
	tests := []struct {
		name       string
		tree       string
		entrypoint string
